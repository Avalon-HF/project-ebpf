...
void* btf_read(void * index)
{
    return __builtin_preserve_access_index(index);
}

// trace_event_raw_kfree_skb trace_event_raw_kfree_skb(struct sk_buff *sk_buff)
// {
// 	return __builtin_preserve_access_index(sk_buff->trace_event_raw_kfree_skb)
// }
